...
public class View extends JPanel {
    ...
    private JLabel scoreLabel; // 🧩 JLabel untuk skor

    public View(Logic logic) {
        this.logic = logic;
        setPreferredSize(new Dimension(width, height));
        setLayout(null); // supaya posisi JLabel bisa diatur manual
        ...
        scoreLabel.setBounds(20, 10, 200, 40); // posisi di pojok kiri atas
        add(scoreLabel);
